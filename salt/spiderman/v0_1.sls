...
Create spiderman data content:
  file.managed:
    - names:
      - /run/spiderman-0.1/index.html:
        - source: salt://spiderman/index.html
      - /run/spiderman-0.1/spiderman.png:
        - source: salt://spiderman/spiderman-0.1.png
...
Run spiderman docker:
  docker_container.running:
    ...
    - port_bindings:
      - 8080:80
    - binds:
      - /run/spiderman-0.1:/var/lib/nginx/html:ro,Z
    - auto_remove: True
